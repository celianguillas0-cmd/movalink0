...
export const cardClass =
  "bg-white dark:bg-zinc-900 rounded-xl border border-gray-100 dark:border-zinc-800 p-5";
...
export const primaryBtnClass =
  "bg-zinc-900 dark:bg-white hover:opacity-90 disabled:opacity-50 text-white dark:text-zinc-900 px-4 py-2.5 rounded-lg font-semibold text-sm transition-all duration-150 active:scale-[0.97] disabled:active:scale-100";
