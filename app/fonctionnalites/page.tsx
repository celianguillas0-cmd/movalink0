...
export const metadata: Metadata = {
  ...
  description:
    "Liens, réseaux, bibliothèque de jeux, 55 effets animés très travaillés et statistiques en direct : tout ce que ta page Movalink sait faire.",
};
...
const FEATURES = [
  ...
  },
  {
    ...
    text: "55 effets animés très travaillés — feux d'artifice, hyperespace, éclairs, aurore, papillons — plus couleurs, dégradés, polices gaming et thèmes exclusifs. Une page que personne d'autre n'a.",
  },
  {
    icon: ChartIcon,
